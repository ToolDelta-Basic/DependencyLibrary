...
ifeq ($(CGO_ENABLED),1)
	...
	ANDROID_ARM64_CC:=$(shell if [ -z ${ANDROID_ARM64_CC} ]; then echo ${HOME}/android-ndk-r20b/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-darwin-android21-clang; else echo ${ANDROID_ARM64_CC}; fi)
endif
# end c/c++ toolchain
